...
STAGES = (
    ...
    _stage("09_build_case_package", 9, ("PACKAGE_PATIENT_FASTA", "PACKAGE_PATIENT_METADATA", "ASSEMBLY_RECORD_MAPPINGS",
        "UNIFIED_NORMALIZED_EVIDENCE", "UNIFIED_EVIDENCE_SUMMARY", "UNIFIED_SOURCE_REGISTRY", "UNIFIED_VALIDATION_REPORT",
        "LOCUS_CONFIG", "RUN_CONFIG", "PIPELINE_MANIFEST"), ("CASE_PACKAGE",), ("PIPELINE",), optional_inputs=(
        "PREPARED_MINI_BAM", "PREPARED_MINI_BAM_INDEX", "ASSEMBLY_ALIGNMENT_OUTPUTS", "CALLER_NATIVE_OUTPUTS",
        "CALLER_RUN_METADATA", "CALLER_NORMALIZED_ARTIFACTS", "LAST_ALIGNMENT_OUTPUTS")),
    _stage("10_validate_case_package", 10, ("CASE_PACKAGE",), ("PACKAGE_VALIDATION_REPORT",), ("PIPELINE",)),
)
