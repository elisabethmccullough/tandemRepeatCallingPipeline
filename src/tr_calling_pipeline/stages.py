...
STAGES = (
    _stage("00_validate_inputs", 0, ("ASSEMBLY_FASTA", "MINI_BAM", "MINI_BAM_INDEX", "REFERENCE_FASTA", "REFERENCE_FASTA_INDEX", "LOCUS_CONFIG"), ("VALIDATED_INPUTS",), ("PYTHON",)),
    _stage("01_prepare_bam", 1, ("MINI_BAM", "MINI_BAM_INDEX"), ("PREPARED_MINI_BAM", "PREPARED_MINI_BAM_INDEX"), ("SAMTOOLS",)),
    _stage("02_align_assembly", 2, ("ASSEMBLY_FASTA", "REFERENCE_FASTA"), ("ALIGNED_ASSEMBLY", "ALIGNED_ASSEMBLY_INDEX"), ("MINIMAP2", "SAMTOOLS")),
    _stage("03_run_vamos_read", 3, ("PREPARED_MINI_BAM", "LOCUS_CONFIG"), ("VAMOS_READ_NATIVE_OUTPUT",), optional=("VAMOS",)),
    _stage("04_run_vamos_contig", 4, ("ALIGNED_ASSEMBLY", "LOCUS_CONFIG"), ("VAMOS_CONTIG_NATIVE_OUTPUT",), optional=("VAMOS",)),
    _stage("05_run_straglr", 5, ("PREPARED_MINI_BAM", "REFERENCE_FASTA", "LOCUS_CONFIG"), ("STRAGLR_NATIVE_OUTPUT",), optional=("STRAGLR",)),
    _stage("06_prepare_tandem_genotypes", 6, ("PREPARED_MINI_BAM", "REFERENCE_FASTA", "LOCUS_CONFIG"), ("TANDEM_GENOTYPES_ALIGNMENT_INPUT",), optional=("LASTDB", "LASTAL")),
    _stage("07_run_tandem_genotypes", 7, ("TANDEM_GENOTYPES_ALIGNMENT_INPUT", "LOCUS_CONFIG"), ("TANDEM_GENOTYPES_NATIVE_OUTPUT",), optional=("TANDEM_GENOTYPES",)),
    _stage("08_normalize_outputs", 8, ("NATIVE_CALLER_OUTPUTS",), ("NORMALIZED_EVIDENCE",), ("PYTHON",)),
